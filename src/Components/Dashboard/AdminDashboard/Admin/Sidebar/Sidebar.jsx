    ...
    <div className="flex sticky bg-white -mt-20">
      <div className={` ${open ? "w-72 h-full min-h-screen" : "w-20 h-full min-h-screen"} bg-[#EBEFEE] sticky p-5 duration-300`} >
        ...
        <div className="flex flex-col gap-x-4 items-center">
          <img src="https://i.ibb.co/nn1pDMg/Readify.png" alt="logo" className={`cursor-pointer w-2/3 pb-5 mx-auto opacity-0 duration-500 ${open && " w-2/3 rotate-[360deg] opacity-100"}`} />
