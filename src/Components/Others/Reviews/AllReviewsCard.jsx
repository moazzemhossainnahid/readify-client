...
import { FaBook, FaRegStar, FaStar } from 'react-icons/fa';
  ...
  return (
    <div className="w-full h-fit border rounded-md mt-6 mx-auto px-5 pt-10 pb-5 relative">
      ...
      <div className="w-full h-full">
        ...
        <img src={review?.product_image} alt="" className="w-12 h-12 rounded-full mx-auto" />
        </div>
        <div className="pt-5 space-y-3">
          ...
          <div className="mt-5">
            <p className="font-medium flex items-center justify-center gap-2"> <FaBook/> {review?.product_name}</p>
          </div>
