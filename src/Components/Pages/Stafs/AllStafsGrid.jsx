...
const AllStafsGrid = ({ staf }) => {
  return (
    <div className="w-full mx-auto">
      ...
      <div className="w-full relative mt-16 mb-32">
        <div className="rounded overflow-hidden shadow-md bg-white">
          ...
          <div className="px-6 mt-16 space-y-3">
            <div className="font-bold text-xl md:text-2xl text-center pb-1">
              {staf?.name}
            </div>
            ...
            <p className="text-center text-gray-600 text-base pt-3 font-normal">
              <span className="font-bold">Work:</span> {staf?.work_name}
            </p>
