...
const AboutUS = () => {
    return (
        <div className='w-full'>
            <div className={` bg-[url('https://t4.ftcdn.net/jpg/04/92/06/53/360_F_492065380_eSlHdkdNBy6ArNkk5gV0Lme1qhvTosSI.jpg')] bg-cover h-[450px] relative bg-no-repeat flex items-center  `}>
                <div className="text-white max-w-2xl flex flex-col justify-end pl-10 font-bold ">
                    <h2 className="text-xl md:text-2xl uppercase mb-2 font-mono">About Readify</h2>
                    <h3 className="text-3xl md:text-7xl font-mono">
