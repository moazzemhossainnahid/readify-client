...
import { Clock } from '../../../Components/Others/Clock/Clock';
...
const Footer = () => {
  ...
  return (
    <div className='bg-[url(https://images8.alphacoders.com/411/thumbbig-411522.webp)] bg-cover bg-center'>
      ...
      <div className="bg-black opacity-90 text-white w-4/4 m-0 py-10">
        <footer className="text-center lg:text-left bg-black text-white">
          ...
          <div className="mx-6 py-10 text-center md:text-left">
            <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className=" mx-auto">
                ...
                <p className="mb-4">
                  <a href="/books" className=" text-white">Books</a>
                </p>
                <p className="mb-4">
                  <a href="!#" className=" text-white">Others</a>
                </p>
                <p className="mb-4">
          ...
          <div className="text-center p-6 bg-black">
            ...
            <span onClick={() => navigate('/')} className=" text-white cursor-pointer font-semibold tracking-widest"> Readify </span>
          </div>
        </footer>
      </div>
    </div>
